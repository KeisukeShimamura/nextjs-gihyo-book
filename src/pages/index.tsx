...
import ProductCardCarousel from 'components/organisms/ProductCardCrousel'
      ...
      <Flex paddingBottom={2} justifyContent="center">
        ...
        >
          <Box marginBottom={3}>
            ...
            {renderProductCardCarousel(clothersProducts)}
          </Box>
          <Box marginBottom={3}>
            <Text as="h2" variant="large">
              本
...
export const getStaticProps: GetStaticProps = async () => {
  ...
  const [clothersProducts, bookProducts, shoesProducts] = await Promise.all([
